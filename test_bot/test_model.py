...
def test_challenge() -> None:
    ...
    user_profile: UserProfileType = {
        ...
        "username": "b",
        "perfs": {
            "bullet": {"games": 100, "rating": 3000, "rd": 150, "prog": -10},
        ...
        "playTime": {"total": 1000000, "tv": 10000},
    ...
    assert challenge_model.is_supported(
        configuration, recent_challenges, Counter()
    ) == (True, "")
...
def test_game() -> None:
    ...
    game: GameEventType = {
        ...
        "initialFen": "startpos",
        "clock": {"initial": 90000, "increment": 1000},
        "type": "gameFull",
        "state": {
            "type": "gameState",
            "moves": "",
