...
def test_lichess() -> None:
    ...
    assert profile == {
        ...
        "createdAt": 1627834995597,
        "followable": True,
        "following": False,
        "id": "badsunfish",
        "perfs": {
            "blitz": {"games": 0, "prog": 0, "prov": True, "rating": 1500, "rd": 500},
        ...
        "playTime": {"total": 1873, "tv": 0},
        "seenAt": 1700000000000,
        "title": "BOT",
        "url": "https://lichess.org/@/BadSunfish",
        "username": "BadSunfish",
    }
    ...
    assert public_data == {
        ...
        "createdAt": 1524037267522,
        "followable": True,
        "following": False,
        "id": "lichapibot",
        "perfs": {
            "blitz": {"games": 2430, "prog": 3, "prov": True, "rating": 2388, "rd": 0},
        ...
        "playTime": {"total": 4111502, "tv": 1582068},
        "profile": {},
        "seenAt": 1669272254317,
        "title": "BOT",
        "tosViolation": True,
        "url": "https://lichess.org/@/lichapibot",
        "username": "lichapibot",
    }
