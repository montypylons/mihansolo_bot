...
TEST(GameOverTest, BasicAssertions)
{
    ...
    ASSERT_FALSE(engine::game_over(,TODO));
    ASSERT_FALSE(engine::game_over(chess::Board("4rbkr/ppp3pp/5N2/n7/3pP2q/5Q1P/PPP1K2P/R1B2R2 b - - 0 15"),TODO));
    ASSERT_FALSE(
        engine::game_over(chess::Board("6k1/3n3b/1pq1r1p1/p1bpPrPp/Pp1p3P/1N1P1N2/R1P3Q1/2B1R1K1 w - - 1 28"),TODO));
